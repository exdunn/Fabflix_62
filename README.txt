...
******************************
javac -cp "lib/servlet-api-3.0.jar;lib/mysql-connector-java-5.1.41-bin.jar;lib/gson-2.3.1.jar;classes" -d classes src/servlets/*.java
...
Log parser reads the catalina.out files which logs TS and TJ when Fabflix makes search queries.
It reads the file line by line and extracts TS and TJ, and finds their average.

-Runs separately from fabflix
